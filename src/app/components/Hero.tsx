 ...
 * 
 * Funcionalidad:
 * - Hero principal con valor de propuesta única
 * - CTA directo a WhatsApp para conversiones
 * - Indicadores de confianza (pago al finalizar, higiene, ubicación)
 * - Optimizado para Google Ads e Instagram Ads (móvil first)
 * 
 * Conversiones:
 * - Botón principal conecta directamente a WhatsApp
 * - Mensaje predefinido para facilitar contacto
 * - Indicadores que reducen fricción de confianza
 */
export default function Hero() {
  // Función para abrir WhatsApp con mensaje predefinido
  // Optimizado para conversión desde anuncios
  const handleWhatsAppBooking = () => {
    // Trackear conversión de Google Ads antes de abrir WhatsApp
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-luxury overflow-hidden">
      {/* Elementos decorativos de fondo - sutiles para no distraer del CTA */}
      ...
      <div className="container-luxury relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Contenido principal - Valor de propuesta y CTA */}
          <div className="text-center lg:text-left">
            {/* Badge de servicio premium */}
            <div className="mb-6">
            ...
            {/* Título principal - Optimizado para anuncios móviles */}
            ...
            {/* Descripción del valor - Enfocada en beneficios únicos */}
            ...
            {/* Indicadores de confianza - Reducen fricción para conversión */}
            <div className="grid md:grid-cols-3 gap-4 mb-8 max-w-4xl mx-auto lg:mx-0">
              {/* Pago al finalizar - Principal objeción resuelta */}
              ...
              {/* Higiene - Concern principal post-COVID */}
              ...
              {/* Ubicación - Segmentación geográfica clara */}
            ...
            {/* CTA Principal - Botón de conversión optimizado */}
            <div className="text-center lg:text-left mb-6">
              <button
                onClick={handleWhatsAppBooking}
                className="btn-primary inline-flex items-center justify-center gap-2 text-lg px-8 py-4"
              >
                {/* Icono de WhatsApp - Reconocible universalmente */}
            ...
            {/* Social proof - Credibilidad y autoridad */}
          ...
          <div className="relative">
            ...
            {/* Elementos flotantes - Urgencia y social proof */}
            {/* Indicador de disponibilidad - Crea urgencia */}
