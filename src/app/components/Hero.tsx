      ...
      <div className="container-luxury relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Trust Message */}
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-8 max-w-xl mx-auto lg:mx-0">
              <div className="flex items-center gap-3 justify-center lg:justify-start mb-2">
                <span className="text-green-600 text-xl">🛡️</span>
                <span className="font-semibold text-green-700">100% Seguro</span>
              </div>
              <p className="text-green-600 text-sm text-center lg:text-left">
                <strong>No pagas nada por adelantado.</strong> Solo cuando estés feliz con tu servicio. 
                Efectivo, Nequi o transferencia al finalizar.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-6 text-sm text-gray-600">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Habla directo conmigo</span>
              </div>
            </div>
          </div>
